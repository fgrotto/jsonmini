...
#define ASSERT(EXP, context)                                                                \
	...
	{                                                                                   \
		fprintf(stderr,                                                             \
			"jsoninc: ASSERT(" #EXP "): `" context "` failed at %s, line %d\n", \
			__FILE__, __LINE__);                                                \
		exit(EXIT_FAILURE);                                                         \
	}

/**
 * Enum representing the different JSON types.
 */
enum json_type
{
	json_number,
...
/**
 * Struct representing a JSON value.
 */
struct json_value
{
	enum json_type type;
...
/**
 * Struct representing a JSON parser.
 */
struct json
{
	char *input;
